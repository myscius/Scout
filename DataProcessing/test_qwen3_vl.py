...
import sys
# 配置日志系统
log_tag = 'VideoMME_qwen3_vl'  # 可以根据需要修改标签
Nf = 16
...
if __name__ == "__main__":
    ...
    distribution_mode = 0 # 0: uniform sampling, 1: distributional sampling with q, 2: distributional sampling with subtitles
    ...
    agent = SelfAgent('Qwen/Qwen3-VL-4B-Instruct')
